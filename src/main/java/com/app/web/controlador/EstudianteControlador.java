...
public class EstudianteControlador {
	...
	// Método para pasarle un objeto estudiante y pasarle los parámetros del
	...
	// Con el path variable recibo un id
	...
	public String actualizarEstudiante(@PathVariable Long id, @ModelAttribute("estudiante") Estudiante estudiante,
		...
		servicio.acturalizarEstudiante(estudianteExistente);
		return "redirect:/estudiantes";
	}
